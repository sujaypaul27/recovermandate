...
public class HeuristicFallbackEngine {
    ...
    private static final Map<String, String> TEMPLATES = Map.of(
            ...
            "If you no longer wish to continue your subscription, you can cancel anytime in your account settings or by contacting our support team.\n\n" +
            "Sincerely,\n" +
            "The %s Team",
            ...
            "If you no longer wish to continue your subscription, you can cancel anytime in your account settings or by reaching out to support.\n\n" +
            "Sincerely,\n" +
            "The %s Team",
    ...
    /**
     * Generates a deterministic recovery message template based on failure category and merchant branding.
     *
     ...
     * @param merchantName  Merchant / business display name
     * @return Formatted recovery message draft
     */
    public String generateTemplate(String category, Long amountInPaise, String currency, String merchantName) {
        ...
        String safeMerchantName = merchantName != null && !merchantName.isBlank() ? merchantName.trim() : "RecoverMandate";

        log.info("Heuristic fallback draft generated for category={} merchant={}", safeCategory, safeMerchantName);
        return String.format(Locale.US, template, amountFormatted, safeCurrency, safeMerchantName);
    }

    public String generateTemplate(String category, Long amountInPaise, String currency) {
        return generateTemplate(category, amountInPaise, currency, "RecoverMandate");
    }
}
